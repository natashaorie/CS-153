...
801011f8:	e8 93 32 00 00       	call   80104490 <memset>
  log_write(bp);
...
80101239:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
8010123c:	e8 0f 31 00 00       	call   80104350 <acquire>
...
80101276:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101279:	e8 c2 31 00 00       	call   80104440 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
801012be:	e8 7d 31 00 00       	call   80104440 <release>
...
801013d2:	e8 59 31 00 00       	call   80104530 <memmove>
  brelse(bp);
...
8010149b:	e8 c0 2d 00 00       	call   80104260 <initlock>
  for(i = 0; i < NINODE; i++) {
...
801014b0:	80 
801014b1:	e8 9a 2c 00 00       	call   80104150 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
801015b9:	e8 d2 2e 00 00       	call   80104490 <memset>
      dip->type = type;
...
8010166f:	00 
80101670:	e8 bb 2e 00 00       	call   80104530 <memmove>
  log_write(bp);
...
801016a1:	e8 aa 2c 00 00       	call   80104350 <acquire>
  ip->ref++;
801016a6:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
801016aa:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016b1:	e8 8a 2d 00 00       	call   80104440 <release>
  return ip;
}
...
801016e4:	e8 a7 2a 00 00       	call   80104190 <acquiresleep>
...
8010175b:	e8 d0 2d 00 00       	call   80104530 <memmove>
    brelse(bp);
...
801017b5:	e8 76 2a 00 00       	call   80104230 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
801017ce:	e9 1d 2a 00 00       	jmp    801041f0 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
801017f2:	e8 99 29 00 00       	call   80104190 <acquiresleep>
...
80101808:	e8 e3 29 00 00       	call   801041f0 <releasesleep>

  acquire(&icache.lock);
8010180d:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101814:	e8 37 2b 00 00       	call   80104350 <acquire>
  ip->ref--;
...
8010182a:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
8010182b:	e9 10 2c 00 00       	jmp    80104440 <release>
void
iput(struct inode *ip)
{
  acquiresleep(&ip->lock);
...
80101837:	e8 14 2b 00 00       	call   80104350 <acquire>
    int r = ip->ref;
8010183c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010183f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101846:	e8 f5 2b 00 00       	call   80104440 <release>
    if(r == 1){
...
80101a18:	e8 13 2b 00 00       	call   80104530 <memmove>
    brelse(bp);
...
80101b14:	e8 17 2a 00 00       	call   80104530 <memmove>
    log_write(bp);
...
80101bbb:	e8 f0 29 00 00       	call   801045b0 <strncmp>
}
80101bc0:	c9                   	leave  
80101bc1:	c3                   	ret    
...
80101c39:	e8 72 29 00 00       	call   801045b0 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101cb8:	e8 93 26 00 00       	call   80104350 <acquire>
  ip->ref++;
80101cbd:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cc1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cc8:	e8 73 27 00 00       	call   80104440 <release>
...
80101d2b:	e8 00 28 00 00       	call   80104530 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101db9:	e8 72 27 00 00       	call   80104530 <memmove>
    name[len] = 0;
...
80101eb3:	e8 68 27 00 00       	call   80104620 <strncpy>
  de.inum = inum;
...
80102025:	e8 36 22 00 00       	call   80104260 <initlock>
...
801020a0:	e8 ab 22 00 00       	call   80104350 <acquire>
...
801020cc:	e8 bf 1e 00 00       	call   80103f90 <wakeup>
...
801020e6:	e8 55 23 00 00       	call   80104440 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
80102140:	e8 eb 20 00 00       	call   80104230 <holdingsleep>
...
80102176:	e8 d5 21 00 00       	call   80104350 <acquire>
...
8010233a:	e8 51 21 00 00       	call   80104490 <memset>
...
80102373:	5d                   	pop    %ebp
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
80102374:	e9 c7 20 00 00       	jmp    80104440 <release>
...
80102387:	e8 c4 1f 00 00       	call   80104350 <acquire>
...
8010240a:	e8 51 1e 00 00       	call   80104260 <initlock>
...
801024dd:	e8 5e 1f 00 00       	call   80104440 <release>
  return (char*)r;
}
...
801024f7:	e8 54 1e 00 00       	call   80104350 <acquire>
...
801028ac:	e8 2f 1c 00 00       	call   801044e0 <memcmp>
...
801029d7:	e8 54 1b 00 00       	call   80104530 <memmove>
...
80102a9a:	e8 c1 17 00 00       	call   80104260 <initlock>
  readsb(dev, &sb);
...
80102b2d:	e8 1e 18 00 00       	call   80104350 <acquire>
...
80102b75:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b7a:	e8 c1 18 00 00       	call   80104440 <release>
      break;
    }
  }
}
...
80102ba0:	e8 ab 17 00 00       	call   80104350 <acquire>
  log.outstanding -= 1;
...
80102bd8:	00 00 00 
  ...
  release(&log.lock);
80102bdb:	e8 60 18 00 00       	call   80104440 <release>
}
...
80102c3f:	e8 ec 18 00 00       	call   80104530 <memmove>
...
80102cfd:	e8 4e 16 00 00       	call   80104350 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d4e:	5d                   	pop    %ebp
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102d4f:	e9 ec 16 00 00       	jmp    80104440 <release>
...
80102db7:	e8 b4 29 00 00       	call   80105770 <idtinit>
...
80102dcf:	e8 ec 0b 00 00       	call   801039c0 <scheduler>
...
80102de3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102de6:	e8 55 3a 00 00       	call   80106840 <switchkvm>
  seginit();
80102deb:	e8 90 39 00 00       	call   80106780 <seginit>
  lapicinit();
...
80102e23:	e8 a8 3e 00 00       	call   80106cd0 <kvmalloc>
...
80102e35:	e8 46 39 00 00       	call   80106780 <seginit>
  picinit();       // disable pic
...
80102e4a:	e8 51 2c 00 00       	call   80105aa0 <uartinit>
80102e4f:	90                   	nop
  pinit();         // process table
80102e50:	e8 ab 07 00 00       	call   80103600 <pinit>
  tvinit();        // trap vectors
80102e55:	e8 76 28 00 00       	call   801056d0 <tvinit>
  binit();         // buffer cache
...
80102e81:	e8 aa 16 00 00       	call   80104530 <memmove>
...
80102f5b:	e8 80 15 00 00       	call   801044e0 <memcmp>
...
80103016:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103019:	e8 c2 14 00 00       	call   801044e0 <memcmp>
...
801031f6:	80 
801031f7:	e8 64 10 00 00       	call   80104260 <initlock>
  (*f0)->type = FD_PIPE;
...
80103281:	e8 ca 10 00 00       	call   80104350 <acquire>
  if(writable){
...
8010329d:	e8 ee 0c 00 00       	call   80103f90 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032be:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
801032bf:	e9 7c 11 00 00       	jmp    80104440 <release>
...
801032db:	e8 b0 0c 00 00       	call   80103f90 <wakeup>
...
801032eb:	e8 50 11 00 00       	call   80104440 <release>
    kfree((char*)p);
...
8010335f:	e8 2c 0c 00 00       	call   80103f90 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103392:	e8 a9 10 00 00       	call   80104440 <release>
        return -1;
...
801033da:	e8 b1 0b 00 00       	call   80103f90 <wakeup>
  release(&p->lock);
801033df:	89 1c 24             	mov    %ebx,(%esp)
801033e2:	e8 59 10 00 00       	call   80104440 <release>
  return n;
...
80103402:	e8 49 0f 00 00       	call   80104350 <acquire>
...
8010345b:	e8 e0 0f 00 00       	call   80104440 <release>
...
801034b5:	e8 d6 0a 00 00       	call   80103f90 <wakeup>
  release(&p->lock);
801034ba:	89 34 24             	mov    %esi,(%esp)
801034bd:	e8 7e 0f 00 00       	call   80104440 <release>
  return i;
}
...
801034e3:	e8 68 0e 00 00       	call   80104350 <acquire>
...
80103509:	a1 04 a0 10 80       	mov    0x8010a004,%eax
  p->status = 0;		// initialize status and priority in embryo
  p->priority = 20;
...
80103515:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
  p->status = 0;		// initialize status and priority in embryo
8010351c:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  release(&ptable.lock);
  return 0;
...
8010352c:	89 43 10             	mov    %eax,0x10(%ebx)
  p->status = 0;		// initialize status and priority in embryo
  p->priority = 20;
8010352f:	c7 83 80 00 00 00 14 	movl   $0x14,0x80(%ebx)
80103536:	00 00 00 

  release(&ptable.lock);
80103539:	e8 02 0f 00 00       	call   80104440 <release>
...
80103555:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103558:	c7 40 14 c5 56 10 80 	movl   $0x801056c5,0x14(%eax)
...
80103572:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103575:	e8 16 0f 00 00       	call   80104490 <memset>
...
80103597:	e8 a4 0e 00 00       	call   80104440 <release>
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
...
801035bd:	e8 7e 0e 00 00       	call   80104440 <release>
...
80103606:	c7 44 24 04 35 74 10 	movl   $0x80107435,0x4(%esp)
8010360d:	80 
8010360e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103615:	e8 46 0c 00 00       	call   80104260 <initlock>
}
8010361a:	c9                   	leave  
8010361b:	c3                   	ret    
...
80103678:	eb ea                	jmp    80103664 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010367a:	c7 04 24 3c 74 10 80 	movl   $0x8010743c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103686:	c7 04 24 34 75 10 80 	movl   $0x80107534,(%esp)
...
801036c4:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
801036c7:	e8 44 0c 00 00       	call   80104310 <pushcli>
  c = mycpu();
801036cc:	e8 4f ff ff ff       	call   80103620 <mycpu>
  p = c->proc;
801036d1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036d7:	e8 f4 0c 00 00       	call   801043d0 <popcli>
  return p;
}
...
80103703:	e8 38 35 00 00       	call   80106c40 <setupkvm>
...
80103725:	80 
80103726:	e8 45 32 00 00       	call   80106970 <inituvm>
  p->sz = PGSIZE;
...
80103747:	e8 44 0d 00 00       	call   80104490 <memset>
...
801037a2:	00 
801037a3:	c7 44 24 04 65 74 10 	movl   $0x80107465,0x4(%esp)
801037aa:	80 
801037ab:	89 04 24             	mov    %eax,(%esp)
801037ae:	e8 bd 0e 00 00       	call   80104670 <safestrcpy>
  p->cwd = namei("/");
801037b3:	c7 04 24 6e 74 10 80 	movl   $0x8010746e,(%esp)
...
801037c9:	e8 82 0b 00 00       	call   80104350 <acquire>
...
801037dc:	e8 5f 0c 00 00       	call   80104440 <release>
}
...
801037e6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037e7:	c7 04 24 4c 74 10 80 	movl   $0x8010744c,(%esp)
...
80103829:	e8 82 32 00 00       	call   80106ab0 <allocuvm>
...
80103837:	e8 24 30 00 00       	call   80106860 <switchuvm>
  return 0;
...
8010385a:	e8 41 33 00 00       	call   80106ba0 <deallocuvm>
...
8010389e:	e8 7d 34 00 00       	call   80106d20 <copyuvm>
...
8010391d:	e8 4e 0d 00 00       	call   80104670 <safestrcpy>
...
8010392c:	e8 1f 0a 00 00       	call   80104350 <acquire>
...
8010393f:	e8 fc 0a 00 00       	call   80104440 <release>
...
80103987:	8b 5d 08             	mov    0x8(%ebp),%ebx
	struct proc *p = myproc(); 
8010398a:	e8 31 fd ff ff       	call   801036c0 <myproc>
	if(priority >= 0 && priority <= 31) {
8010398f:	83 fb 1f             	cmp    $0x1f,%ebx
80103992:	77 14                	ja     801039a8 <setprior+0x28>
		p->priority = priority;
80103994:	89 98 80 00 00 00    	mov    %ebx,0x80(%eax)
	else {
		cprintf("ERROR: wrong priority value");
		return 1;
	}
		
}
8010399a:	83 c4 14             	add    $0x14,%esp
setprior(int priority)
{
	struct proc *p = myproc(); 
	if(priority >= 0 && priority <= 31) {
...
801039a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	if(priority >= 0 && priority <= 31) {
		...
		cprintf("ERROR: wrong priority value");
801039a8:	c7 04 24 70 74 10 80 	movl   $0x80107470,(%esp)
801039af:	e8 9c cc ff ff       	call   80100650 <cprintf>
		return 1;
	}
		
}
801039b4:	83 c4 14             	add    $0x14,%esp
		p->priority = priority;
		return 0;
	}
	else {
		cprintf("ERROR: wrong priority value");
		return 1;
801039b7:	b8 01 00 00 00       	mov    $0x1,%eax
	}
...
801039c6:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *p, *t, *top; //t = temporary variable, top = process with highest priority
  struct cpu *c = mycpu();
801039c9:	e8 52 fc ff ff       	call   80103620 <mycpu>
  c->proc = 0;
801039ce:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
801039d5:	00 00 00 
//      via swtch back to the scheduler.
void
scheduler(void)
...
801039da:	8d 40 04             	lea    0x4(%eax),%eax
...
801039e1:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039e8:	be 54 2d 11 80       	mov    $0x80112d54,%esi
  for(;;){
    // Enable interrupts on this processor.
    sti();
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
801039ed:	e8 5e 09 00 00       	call   80104350 <acquire>
801039f2:	eb 16                	jmp    80103a0a <scheduler+0x4a>
801039f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039f8:	81 c6 84 00 00 00    	add    $0x84,%esi
801039fe:	81 fe 54 4e 11 80    	cmp    $0x80114e54,%esi
80103a04:	0f 84 8f 00 00 00    	je     80103a99 <scheduler+0xd9>
      if(p->state != RUNNABLE)
80103a0a:	83 7e 0c 03          	cmpl   $0x3,0xc(%esi)
80103a0e:	75 e8                	jne    801039f8 <scheduler+0x38>
80103a10:	89 f7                	mov    %esi,%edi
80103a12:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103a17:	eb 15                	jmp    80103a2e <scheduler+0x6e>
80103a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        continue;
        top = p;
		for(t = ptable.proc; t < &ptable.proc[NPROC]; t++) {
80103a20:	81 c2 84 00 00 00    	add    $0x84,%edx
80103a26:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103a2c:	74 23                	je     80103a51 <scheduler+0x91>
			if(t->state != RUNNABLE)
80103a2e:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
80103a32:	75 ec                	jne    80103a20 <scheduler+0x60>
80103a34:	8b 87 80 00 00 00    	mov    0x80(%edi),%eax
80103a3a:	39 82 80 00 00 00    	cmp    %eax,0x80(%edx)
80103a40:	0f 4c fa             	cmovl  %edx,%edi
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      if(p->state != RUNNABLE)
        continue;
        top = p;
		for(t = ptable.proc; t < &ptable.proc[NPROC]; t++) {
80103a43:	81 c2 84 00 00 00    	add    $0x84,%edx
80103a49:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103a4f:	75 dd                	jne    80103a2e <scheduler+0x6e>
		}
      ...
      c->proc = top;
80103a51:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a57:	81 c6 84 00 00 00    	add    $0x84,%esi
      ...
      c->proc = top;
      switchuvm(top);
80103a5d:	89 3c 24             	mov    %edi,(%esp)
80103a60:	e8 fb 2d 00 00       	call   80106860 <switchuvm>
      //top->priority = 20; //priority decreased when run
      top->state = RUNNING; 

      swtch(&(c->scheduler), top->context);
80103a65:	8b 57 1c             	mov    0x1c(%edi),%edx
80103a68:	8b 45 e4             	mov    -0x1c(%ebp),%eax
      ...
      //top->priority = 20; //priority decreased when run
      top->state = RUNNING; 
80103a6b:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)

      swtch(&(c->scheduler), top->context);
80103a72:	89 54 24 04          	mov    %edx,0x4(%esp)
80103a76:	89 04 24             	mov    %eax,(%esp)
80103a79:	e8 4d 0c 00 00       	call   801046cb <swtch>
      switchkvm();
80103a7e:	e8 bd 2d 00 00       	call   80106840 <switchkvm>
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a83:	81 fe 54 4e 11 80    	cmp    $0x80114e54,%esi
      swtch(&(c->scheduler), top->context);
      switchkvm();
      ...
      c->proc = 0;
80103a89:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a90:	00 00 00 
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a93:	0f 85 71 ff ff ff    	jne    80103a0a <scheduler+0x4a>
...
80103aa0:	e8 9b 09 00 00       	call   80104440 <release>
    //yield();

  }
80103aa5:	e9 36 ff ff ff       	jmp    801039e0 <scheduler+0x20>
...
80103ac4:	89 c3                	mov    %eax,%ebx
  ...
  if(!holding(&ptable.lock))
80103ac6:	e8 15 08 00 00       	call   801042e0 <holding>
...
80103b07:	e8 bf 0b 00 00       	call   801046cb <swtch>
  mycpu()->intena = intena;
...
80103b1d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103b1e:	c7 04 24 8c 74 10 80 	movl   $0x8010748c,(%esp)
80103b25:	e8 36 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103b2a:	c7 04 24 b8 74 10 80 	movl   $0x801074b8,(%esp)
80103b31:	e8 2a c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103b36:	c7 04 24 aa 74 10 80 	movl   $0x801074aa,(%esp)
80103b3d:	e8 1e c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103b42:	c7 04 24 9e 74 10 80 	movl   $0x8010749e,(%esp)
...
80103b65:	89 c3                	mov    %eax,%ebx
  ...
  if(curproc == initproc)
80103b67:	0f 84 fd 00 00 00    	je     80103c6a <exit+0x11a>
...
80103bb3:	e8 98 07 00 00       	call   80104350 <acquire>
  curproc->status = status;
...
80103bc3:	8b 43 14             	mov    0x14(%ebx),%eax
80103bc6:	eb 0e                	jmp    80103bd6 <exit+0x86>
static void
wakeup1(void *chan)
{
  struct proc *p;
...
80103c52:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103c59:	e8 52 fe ff ff       	call   80103ab0 <sched>
  panic("zombie exit");
80103c5e:	c7 04 24 d9 74 10 80 	movl   $0x801074d9,(%esp)
80103c65:	e8 f6 c6 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103c6a:	c7 04 24 cc 74 10 80 	movl   $0x801074cc,(%esp)
...
80103c8d:	e8 be 06 00 00       	call   80104350 <acquire>
...
80103caa:	e8 91 07 00 00       	call   80104440 <release>
}
80103caf:	c9                   	leave  
80103cb0:	c3                   	ret    
...
80103cf1:	e8 5a 06 00 00       	call   80104350 <acquire>
    release(lk);
80103cf6:	89 34 24             	mov    %esi,(%esp)
80103cf9:	e8 42 07 00 00       	call   80104440 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d1b:	e8 20 07 00 00       	call   80104440 <release>
    acquire(lk);
...
80103d29:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103d2a:	e9 21 06 00 00       	jmp    80104350 <acquire>
80103d2f:	90                   	nop
  if(lk != &ptable.lock){  //DOC: sleeplock0
    acquire(&ptable.lock);  //DOC: sleeplock1
    release(lk);
...
80103d4e:	c7 04 24 eb 74 10 80 	movl   $0x801074eb,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103d5a:	c7 04 24 e5 74 10 80 	movl   $0x801074e5,(%esp)
...
80103d79:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  int havekids, pid;
  struct proc *curproc = myproc();
80103d7c:	e8 3f f9 ff ff       	call   801036c0 <myproc>
...
80103d88:	89 c6                	mov    %eax,%esi
  ...
  acquire(&ptable.lock);
80103d8a:	e8 c1 05 00 00       	call   80104350 <acquire>
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
80103d8f:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d91:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103d96:	eb 0e                	jmp    80103da6 <wait+0x36>
...
80103daf:	74 57                	je     80103e08 <wait+0x98>
...
80103dca:	74 19                	je     80103de5 <wait+0x75>
80103dcc:	8b 46 24             	mov    0x24(%esi),%eax
80103dcf:	85 c0                	test   %eax,%eax
80103dd1:	75 12                	jne    80103de5 <wait+0x75>
	  }
      return -1;
    }
...
80103de3:	eb aa                	jmp    80103d8f <wait+0x1f>
      }
    }
...
80103dec:	e8 4f 06 00 00       	call   80104440 <release>
      if(status != 0) {
80103df1:	85 ff                	test   %edi,%edi
80103df3:	74 72                	je     80103e67 <wait+0xf7>
		*status= -1;
80103df5:	c7 07 ff ff ff ff    	movl   $0xffffffff,(%edi)
	  }
      return -1;
80103dfb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    }
...
80103e00:	83 c4 1c             	add    $0x1c,%esp
80103e03:	5b                   	pop    %ebx
80103e04:	5e                   	pop    %esi
80103e05:	5f                   	pop    %edi
80103e06:	5d                   	pop    %ebp
80103e07:	c3                   	ret    
      ...
      if(p->state == ZOMBIE){
        ...
        pid = p->pid;
        kfree(p->kstack);
80103e08:	8b 43 08             	mov    0x8(%ebx),%eax
      if(p->parent != curproc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
80103e0b:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103e0e:	89 04 24             	mov    %eax,(%esp)
80103e11:	e8 ea e4 ff ff       	call   80102300 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80103e16:	8b 43 04             	mov    0x4(%ebx),%eax
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
80103e19:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e20:	89 04 24             	mov    %eax,(%esp)
80103e23:	e8 98 2d 00 00       	call   80106bc0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103e28:	85 ff                	test   %edi,%edi
        ...
        freevm(p->pgdir);
        p->pid = 0;
80103e2a:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103e31:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103e38:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103e3c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103e43:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        if(status) {
80103e4a:	74 05                	je     80103e51 <wait+0xe1>
			*status = p->status;
80103e4c:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103e4f:	89 07                	mov    %eax,(%edi)
		}
        release(&ptable.lock);
80103e51:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e58:	e8 e3 05 00 00       	call   80104440 <release>
    }
...
80103e5d:	83 c4 1c             	add    $0x1c,%esp
        p->state = UNUSED;
        if(status) {
			*status = p->status;
		}
...
80103e6c:	eb 92                	jmp    80103e00 <wait+0x90>
...
80103e88:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  acquire(&ptable.lock);
80103e8b:	e8 c0 04 00 00       	call   80104350 <acquire>
80103e90:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(;;){
    // Scan through table looking for exited children (doesn't have to be children for waitpid).
    hasp = 0;
80103e93:	31 c9                	xor    %ecx,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e95:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103e9a:	eb 12                	jmp    80103eae <waitpid+0x3e>
80103e9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ea0:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103ea6:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103eac:	74 20                	je     80103ece <waitpid+0x5e>
      if(p->pid != pid)
...
80103eb9:	74 3d                	je     80103ef8 <waitpid+0x88>
  ...
  for(;;){
    ...
    hasp = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ebb:	81 c3 84 00 00 00    	add    $0x84,%ebx
      if(p->pid != pid)
        continue;
      hasp = 1;
80103ec1:	b9 01 00 00 00       	mov    $0x1,%ecx
  ...
  for(;;){
    ...
    hasp = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ec6:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103ecc:	75 e0                	jne    80103eae <waitpid+0x3e>
        return pid;
      }
    }

    // No point waiting if we don't have any children.
    if(!hasp || curproc->killed){
80103ece:	85 c9                	test   %ecx,%ecx
80103ed0:	0f 84 84 00 00 00    	je     80103f5a <waitpid+0xea>
80103ed6:	8b 50 24             	mov    0x24(%eax),%edx
80103ed9:	85 d2                	test   %edx,%edx
80103edb:	75 7d                	jne    80103f5a <waitpid+0xea>
	  }
      return -1;
    }
...
80103ee0:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103ee7:	80 
80103ee8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103eeb:	e8 d0 fd ff ff       	call   80103cc0 <sleep>
  }
80103ef0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103ef3:	eb 9e                	jmp    80103e93 <waitpid+0x23>
80103ef5:	8d 76 00             	lea    0x0(%esi),%esi
      ...
      if(p->state == ZOMBIE){
        ...
        pid = p->pid;
        kfree(p->kstack);
80103ef8:	8b 43 08             	mov    0x8(%ebx),%eax
80103efb:	89 04 24             	mov    %eax,(%esp)
80103efe:	e8 fd e3 ff ff       	call   80102300 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
...
80103f10:	e8 ab 2c 00 00       	call   80106bc0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103f15:	8b 4d 0c             	mov    0xc(%ebp),%ecx
        ...
        freevm(p->pgdir);
        p->pid = 0;
80103f18:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103f1f:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103f26:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
        p->state = UNUSED;
        if(status) {
80103f2a:	85 c9                	test   %ecx,%ecx
        p->kstack = 0;
        freevm(p->pgdir);
        p->pid = 0;
        p->parent = 0;
...
80103f2c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103f33:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        if(status) {
80103f3a:	74 08                	je     80103f44 <waitpid+0xd4>
			*status = p->status;
80103f3c:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103f3f:	8b 55 0c             	mov    0xc(%ebp),%edx
80103f42:	89 02                	mov    %eax,(%edx)
		}
        release(&ptable.lock);
80103f44:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f4b:	e8 f0 04 00 00       	call   80104440 <release>
    }
...
80103f50:	83 c4 1c             	add    $0x1c,%esp
...
80103f61:	e8 da 04 00 00       	call   80104440 <release>
      if(status) {
80103f66:	8b 45 0c             	mov    0xc(%ebp),%eax
80103f69:	85 c0                	test   %eax,%eax
80103f6b:	74 18                	je     80103f85 <waitpid+0x115>
		*status= -1;
80103f6d:	8b 45 0c             	mov    0xc(%ebp),%eax
	  }
      return -1;
80103f70:	be ff ff ff ff       	mov    $0xffffffff,%esi
    ...
    if(!hasp || curproc->killed){
      ...
      if(status) {
		*status= -1;
80103f75:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
    }
...
80103f84:	c3                   	ret    
    if(!hasp || curproc->killed){
      ...
      return -1;
80103f85:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103f8a:	eb c4                	jmp    80103f50 <waitpid+0xe0>
...
80103fa1:	e8 aa 03 00 00       	call   80104350 <acquire>
static void
wakeup1(void *chan)
{
  struct proc *p;
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103fec:	e9 4f 04 00 00       	jmp    80104440 <release>
...
80104045:	e8 f6 03 00 00       	call   80104440 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010406f:	e8 cc 03 00 00       	call   80104440 <release>
  return -1;
}
...
80104094:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80104098:	c7 04 24 7f 78 10 80 	movl   $0x8010787f,(%esp)
...
801040bd:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
801040c0:	ba fc 74 10 80       	mov    $0x801074fc,%edx
  uint pc[10];
...
801040c7:	8b 14 85 5c 75 10 80 	mov    -0x7fef8aa4(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801040ce:	b8 fc 74 10 80       	mov    $0x801074fc,%eax
...
801040e3:	c7 04 24 00 75 10 80 	movl   $0x80107500,(%esp)
...
8010410f:	e8 6c 01 00 00       	call   80104280 <getcallerpcs>
...
80104129:	c7 04 24 21 6f 10 80 	movl   $0x80106f21,(%esp)
...
8010415a:	c7 44 24 04 74 75 10 	movl   $0x80107574,0x4(%esp)
80104161:	80 
80104162:	8d 43 04             	lea    0x4(%ebx),%eax
80104165:	89 04 24             	mov    %eax,(%esp)
80104168:	e8 f3 00 00 00       	call   80104260 <initlock>
  lk->name = name;
...
801041a1:	e8 aa 01 00 00       	call   80104350 <acquire>
  while (lk->locked) {
...
801041b7:	e8 04 fb ff ff       	call   80103cc0 <sleep>
...
801041c2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041c8:	e8 f3 f4 ff ff       	call   801036c0 <myproc>
...
801041db:	5d                   	pop    %ebp
  ...
  lk->pid = myproc()->pid;
  release(&lk->lk);
801041dc:	e9 5f 02 00 00       	jmp    80104440 <release>
...
80104201:	e8 4a 01 00 00       	call   80104350 <acquire>
  lk->locked = 0;
...
80104223:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
80104224:	e9 17 02 00 00       	jmp    80104440 <release>
...
80104241:	e8 0a 01 00 00       	call   80104350 <acquire>
  r = lk->locked;
80104246:	8b 1b                	mov    (%ebx),%ebx
  release(&lk->lk);
80104248:	89 34 24             	mov    %esi,(%esp)
8010424b:	e8 f0 01 00 00       	call   80104440 <release>
  return r;
}
...
801042e9:	8b 55 08             	mov    0x8(%ebp),%edx
  return lock->locked && lock->cpu == mycpu();
801042ec:	8b 0a                	mov    (%edx),%ecx
801042ee:	85 c9                	test   %ecx,%ecx
801042f0:	74 10                	je     80104302 <holding+0x22>
801042f2:	8b 5a 08             	mov    0x8(%edx),%ebx
801042f5:	e8 26 f3 ff ff       	call   80103620 <mycpu>
801042fa:	39 c3                	cmp    %eax,%ebx
801042fc:	0f 94 c0             	sete   %al
801042ff:	0f b6 c0             	movzbl %al,%eax
}
80104302:	83 c4 04             	add    $0x4,%esp
80104305:	5b                   	pop    %ebx
80104306:	5d                   	pop    %ebp
80104307:	c3                   	ret    
80104308:	90                   	nop
...
80104329:	e8 f2 f2 ff ff       	call   80103620 <mycpu>
8010432e:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104334:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010433a:	e8 e1 f2 ff ff       	call   80103620 <mycpu>
...
80104357:	e8 b4 ff ff ff       	call   80104310 <pushcli>
  if(holding(lk))
8010435c:	8b 55 08             	mov    0x8(%ebp),%edx
...
{
  return lock->locked && lock->cpu == mycpu();
8010435f:	8b 02                	mov    (%edx),%eax
80104361:	85 c0                	test   %eax,%eax
80104363:	75 43                	jne    801043a8 <acquire+0x58>
xchg(volatile uint *addr, uint newval)
{
  uint result;
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
80104365:	b9 01 00 00 00       	mov    $0x1,%ecx
8010436a:	eb 07                	jmp    80104373 <acquire+0x23>
...
80104382:	e8 99 f2 ff ff       	call   80103620 <mycpu>
...
8010439a:	e8 e1 fe ff ff       	call   80104280 <getcallerpcs>
}
...
{
  return lock->locked && lock->cpu == mycpu();
801043a8:	8b 5a 08             	mov    0x8(%edx),%ebx
801043ab:	e8 70 f2 ff ff       	call   80103620 <mycpu>
// other CPUs to waste time spinning to acquire it.
void
acquire(struct spinlock *lk)
{
  pushcli(); // disable interrupts to avoid deadlock.
  if(holding(lk))
801043b0:	39 c3                	cmp    %eax,%ebx
801043b2:	74 05                	je     801043b9 <acquire+0x69>
801043b4:	8b 55 08             	mov    0x8(%ebp),%edx
801043b7:	eb ac                	jmp    80104365 <acquire+0x15>
    panic("acquire");
801043b9:	c7 04 24 7f 75 10 80 	movl   $0x8010757f,(%esp)
...
801043db:	75 49                	jne    80104426 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
801043dd:	e8 3e f2 ff ff       	call   80103620 <mycpu>
...
801043f5:	e8 26 f2 ff ff       	call   80103620 <mycpu>
...
80104406:	66 90                	xchg   %ax,%ax
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104408:	e8 13 f2 ff ff       	call   80103620 <mycpu>
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010441a:	c7 04 24 9e 75 10 80 	movl   $0x8010759e,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104426:	c7 04 24 87 75 10 80 	movl   $0x80107587,(%esp)
...
8010444f:	75 0f                	jne    80104460 <release+0x20>
// Release the lock.
void
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104451:	c7 04 24 a5 75 10 80 	movl   $0x801075a5,(%esp)
80104458:	e8 03 bf ff ff       	call   80100360 <panic>
...
{
  return lock->locked && lock->cpu == mycpu();
80104460:	8b 73 08             	mov    0x8(%ebx),%esi
80104463:	e8 b8 f1 ff ff       	call   80103620 <mycpu>
...
{
  if(!holding(lk))
80104468:	39 c6                	cmp    %eax,%esi
8010446a:	75 e5                	jne    80104451 <release+0x11>
    panic("release");

  lk->pcs[0] = 0;
8010446c:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104473:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  // Tell the C compiler and the processor to not move loads or stores
  ...
  __sync_synchronize();
8010447a:	0f ae f0             	mfence 

  // Release the lock, equivalent to lk->locked = 0.
  // This code can't use a C assignment, since it might
  // not be atomic. A real OS would use C atomics here.
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010447d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
...
80104488:	5d                   	pop    %ebp
  ...
  popcli();
80104489:	e9 42 ff ff ff       	jmp    801043d0 <popcli>
...
801046e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801046ea:	e8 d1 ef ff ff       	call   801036c0 <myproc>
...
80104727:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010472a:	e8 91 ef ff ff       	call   801036c0 <myproc>
...
8010478b:	e8 30 ef ff ff       	call   801036c0 <myproc>
...
801047b8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801047bb:	e8 00 ef ff ff       	call   801036c0 <myproc>
...
80104855:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104858:	e8 63 ee ff ff       	call   801036c0 <myproc>
...
80104868:	83 fa 16             	cmp    $0x16,%edx
8010486b:	77 1b                	ja     80104888 <syscall+0x38>
8010486d:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
...
80104896:	c7 04 24 ad 75 10 80 	movl   $0x801075ad,(%esp)
...
801048c6:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
801048c9:	e8 f2 ed ff ff       	call   801036c0 <myproc>
...
8010491c:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
8010491f:	e8 0c d6 ff ff       	call   80101f30 <nameiparent>
...
80104931:	e8 8a cd ff ff       	call   801016c0 <ilock>
...
8010497b:	e8 a0 cf ff ff       	call   80101920 <iunlockput>
    panic("create: dirlink");
...
8010499d:	e8 8e cb ff ff       	call   80101530 <ialloc>
...
801049af:	e8 0c cd ff ff       	call   801016c0 <ilock>
  ip->major = major;
801049b4:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
801049b8:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
801049bc:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
...
801049d0:	e8 2b cc ff ff       	call   80101600 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
801049d5:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
...
801049fb:	83 c4 4c             	add    $0x4c,%esp
  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
...
80104a51:	79 89                	jns    801049dc <create+0xdc>
      panic("create dots");
80104a53:	c7 04 24 4f 76 10 80 	movl   $0x8010764f,(%esp)
80104a5a:	e8 01 b9 ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
80104a5f:	c7 04 24 5e 76 10 80 	movl   $0x8010765e,(%esp)
80104a66:	e8 f5 b8 ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
80104a6b:	c7 04 24 40 76 10 80 	movl   $0x80107640,(%esp)
...
80104aa9:	e8 12 ec ff ff       	call   801036c0 <myproc>
...
80104c23:	78 23                	js     80104c48 <sys_close+0x38>
    return -1;
  myproc()->ofile[fd] = 0;
80104c25:	e8 96 ea ff ff       	call   801036c0 <myproc>
...
80104cd9:	0f 88 cb 00 00 00    	js     80104daa <sys_link+0x10a>
  ...
  begin_op();
80104cdf:	e8 3c de ff ff       	call   80102b20 <begin_op>
  if((ip = namei(old)) == 0){
80104ce4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104ce7:	89 04 24             	mov    %eax,(%esp)
80104cea:	e8 21 d2 ff ff       	call   80101f10 <namei>
...
80104cfc:	e8 bf c9 ff ff       	call   801016c0 <ilock>
  if(ip->type == T_DIR){
...
80104d17:	e8 e4 c8 ff ff       	call   80101600 <iupdate>
  iunlock(ip);
80104d1c:	89 1c 24             	mov    %ebx,(%esp)
80104d1f:	e8 7c ca ff ff       	call   801017a0 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80104d24:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104d27:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104d2b:	89 04 24             	mov    %eax,(%esp)
80104d2e:	e8 fd d1 ff ff       	call   80101f30 <nameiparent>
...
80104d55:	e8 d6 d0 ff ff       	call   80101e30 <dirlink>
...
80104d61:	e8 ba cb ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104d66:	89 1c 24             	mov    %ebx,(%esp)
80104d69:	e8 72 ca ff ff       	call   801017e0 <iput>

  end_op();
80104d6e:	e8 1d de ff ff       	call   80102b90 <end_op>
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
  end_op();
...
80104d83:	e8 98 cb ff ff       	call   80101920 <iunlockput>
  end_op();
...
80104d8b:	e8 30 c9 ff ff       	call   801016c0 <ilock>
  ip->nlink--;
80104d90:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104d95:	89 1c 24             	mov    %ebx,(%esp)
80104d98:	e8 63 c8 ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
80104d9d:	89 1c 24             	mov    %ebx,(%esp)
80104da0:	e8 7b cb ff ff       	call   80101920 <iunlockput>
  end_op();
80104da5:	e8 e6 dd ff ff       	call   80102b90 <end_op>
  return -1;
}
...
80104dde:	0f 88 76 01 00 00    	js     80104f5a <sys_unlink+0x19a>
  ...
  begin_op();
80104de4:	e8 37 dd ff ff       	call   80102b20 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104df6:	e8 35 d1 ff ff       	call   80101f30 <nameiparent>
...
80104e11:	c7 44 24 04 5c 76 10 	movl   $0x8010765c,0x4(%esp)
80104e18:	80 
80104e19:	89 1c 24             	mov    %ebx,(%esp)
80104e1c:	e8 7f cd ff ff       	call   80101ba0 <namecmp>
80104e21:	85 c0                	test   %eax,%eax
80104e23:	0f 84 21 01 00 00    	je     80104f4a <sys_unlink+0x18a>
80104e29:	c7 44 24 04 5b 76 10 	movl   $0x8010765b,0x4(%esp)
80104e30:	80 
80104e31:	89 1c 24             	mov    %ebx,(%esp)
80104e34:	e8 67 cd ff ff       	call   80101ba0 <namecmp>
...
80104e4f:	e8 7c cd ff ff       	call   80101bd0 <dirlookup>
...
80104e61:	e8 5a c8 ff ff       	call   801016c0 <ilock>
...
80104eac:	e8 bf cb ff ff       	call   80101a70 <writei>
...
80104ed8:	e8 23 c7 ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
80104edd:	89 1c 24             	mov    %ebx,(%esp)
80104ee0:	e8 3b ca ff ff       	call   80101920 <iunlockput>

  end_op();
80104ee5:	e8 a6 dc ff ff       	call   80102b90 <end_op>
...
80104f31:	e8 3a ca ff ff       	call   80101970 <readi>
...
80104f45:	e8 d6 c9 ff ff       	call   80101920 <iunlockput>
  end_op();
...
80104f50:	e8 cb c9 ff ff       	call   80101920 <iunlockput>
  end_op();
80104f55:	e8 36 dc ff ff       	call   80102b90 <end_op>
  return -1;
}
...
80104f73:	e8 88 c6 ff ff       	call   80101600 <iupdate>
80104f78:	e9 48 ff ff ff       	jmp    80104ec5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104f7d:	c7 04 24 80 76 10 80 	movl   $0x80107680,(%esp)
80104f84:	e8 d7 b3 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104f89:	c7 04 24 92 76 10 80 	movl   $0x80107692,(%esp)
80104f90:	e8 cb b3 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104f95:	c7 04 24 6e 76 10 80 	movl   $0x8010766e,(%esp)
...
80105004:	e8 07 cf ff ff       	call   80101f10 <namei>
...
80105016:	e8 a5 c6 ff ff       	call   801016c0 <ilock>
...
80105047:	e8 54 c7 ff ff       	call   801017a0 <iunlock>
  end_op();
8010504c:	e8 3f db ff ff       	call   80102b90 <end_op>
...
801050f3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801050f6:	e8 25 da ff ff       	call   80102b20 <begin_op>
...
8010512f:	e8 ec c7 ff ff       	call   80101920 <iunlockput>
  end_op();
80105134:	e8 57 da ff ff       	call   80102b90 <end_op>
  return 0;
...
8010513d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    end_op();
80105140:	e8 4b da ff ff       	call   80102b90 <end_op>
    return -1;
...
80105153:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105156:	e8 c5 d9 ff ff       	call   80102b20 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801051bf:	e8 5c c7 ff ff       	call   80101920 <iunlockput>
  end_op();
801051c4:	e8 c7 d9 ff ff       	call   80102b90 <end_op>
  return 0;
...
801051cd:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if((argstr(0, &path)) < 0 ||
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
801051d0:	e8 bb d9 ff ff       	call   80102b90 <end_op>
    return -1;
...
801051e5:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801051e8:	e8 d3 e4 ff ff       	call   801036c0 <myproc>
...
80105211:	e8 fa cc ff ff       	call   80101f10 <namei>
...
8010521f:	e8 9c c4 ff ff       	call   801016c0 <ilock>
  if(ip->type != T_DIR){
...
8010522c:	75 22                	jne    80105250 <sys_chdir+0x70>
  ...
  iunlock(ip);
8010522e:	e8 6d c5 ff ff       	call   801017a0 <iunlock>
  iput(curproc->cwd);
80105233:	8b 46 68             	mov    0x68(%esi),%eax
80105236:	89 04 24             	mov    %eax,(%esp)
80105239:	e8 a2 c5 ff ff       	call   801017e0 <iput>
  end_op();
8010523e:	e8 4d d9 ff ff       	call   80102b90 <end_op>
  curproc->cwd = ip;
  return 0;
...
8010524f:	90                   	nop
  ...
  if(ip->type != T_DIR){
    iunlockput(ip);
80105250:	e8 cb c6 ff ff       	call   80101920 <iunlockput>
    end_op();
80105255:	e8 36 d9 ff ff       	call   80102b90 <end_op>
  iunlock(ip);
  iput(curproc->cwd);
  end_op();
  curproc->cwd = ip;
...
80105393:	e8 e8 dd ff ff       	call   80103180 <pipealloc>
...
801053c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
801053d0:	e8 eb e2 ff ff       	call   801036c0 <myproc>
...
{
  return fork();
80105404:	e9 67 e4 ff ff       	jmp    80103870 <fork>
...
8010542f:	e8 1c e7 ff ff       	call   80103b50 <exit>
...
80105473:	83 ec 28             	sub    $0x28,%esp
	...
	if (argint(0, &pid)<0)
80105476:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105479:	89 44 24 04          	mov    %eax,0x4(%esp)
8010547d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105484:	e8 f7 f2 ff ff       	call   80104780 <argint>
80105489:	85 c0                	test   %eax,%eax
8010548b:	78 53                	js     801054e0 <sys_waitpid+0x70>
		return -1;
	if(argptr(1, (void *)&status, sizeof(*status))<0)
8010548d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105490:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105497:	00 
80105498:	89 44 24 04          	mov    %eax,0x4(%esp)
8010549c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054a3:	e8 08 f3 ff ff       	call   801047b0 <argptr>
801054a8:	85 c0                	test   %eax,%eax
801054aa:	78 34                	js     801054e0 <sys_waitpid+0x70>
		return -1;
	if(argint(2, &options)<0)
801054ac:	8d 45 f4             	lea    -0xc(%ebp),%eax
801054af:	89 44 24 04          	mov    %eax,0x4(%esp)
801054b3:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801054ba:	e8 c1 f2 ff ff       	call   80104780 <argint>
801054bf:	85 c0                	test   %eax,%eax
801054c1:	78 1d                	js     801054e0 <sys_waitpid+0x70>
		return -1;
...
801054d1:	8b 45 ec             	mov    -0x14(%ebp),%eax
801054d4:	89 04 24             	mov    %eax,(%esp)
801054d7:	e8 94 e9 ff ff       	call   80103e70 <waitpid>
}
801054dc:	c9                   	leave  
801054dd:	c3                   	ret    
...
80105504:	e8 77 f2 ff ff       	call   80104780 <argint>
80105509:	85 c0                	test   %eax,%eax
8010550b:	78 13                	js     80105520 <sys_setprior+0x30>
		return -1;
	}
	return setprior(priority);
8010550d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105510:	89 04 24             	mov    %eax,(%esp)
80105513:	e8 68 e4 ff ff       	call   80103980 <setprior>
...
80105544:	e8 37 f2 ff ff       	call   80104780 <argint>
80105549:	85 c0                	test   %eax,%eax
8010554b:	78 13                	js     80105560 <sys_kill+0x30>
    return -1;
  return kill(pid);
8010554d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105550:	89 04 24             	mov    %eax,(%esp)
80105553:	e8 a8 ea ff ff       	call   80104000 <kill>
}
80105558:	c9                   	leave  
80105559:	c3                   	ret    
...
80105573:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105576:	e8 45 e1 ff ff       	call   801036c0 <myproc>
...
80105595:	e8 e6 f1 ff ff       	call   80104780 <argint>
8010559a:	85 c0                	test   %eax,%eax
8010559c:	78 22                	js     801055c0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010559e:	e8 1d e1 ff ff       	call   801036c0 <myproc>
  if(growproc(n) < 0)
801055a3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  int addr;
  int n;
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = myproc()->sz;
801055a6:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
801055a8:	89 14 24             	mov    %edx,(%esp)
801055ab:	e8 50 e2 ff ff       	call   80103800 <growproc>
801055b0:	85 c0                	test   %eax,%eax
801055b2:	78 0c                	js     801055c0 <sys_sbrk+0x40>
    return -1;
  return addr;
801055b4:	89 d8                	mov    %ebx,%eax
}
801055b6:	83 c4 24             	add    $0x24,%esp
801055b9:	5b                   	pop    %ebx
801055ba:	5d                   	pop    %ebp
801055bb:	c3                   	ret    
...
801055c5:	eb ef                	jmp    801055b6 <sys_sbrk+0x36>
...
801055e5:	e8 96 f1 ff ff       	call   80104780 <argint>
801055ea:	85 c0                	test   %eax,%eax
801055ec:	78 7e                	js     8010566c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801055ee:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
...
801055fa:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801055fd:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
80105603:	85 d2                	test   %edx,%edx
80105605:	75 29                	jne    80105630 <sys_sleep+0x60>
80105607:	eb 4f                	jmp    80105658 <sys_sleep+0x88>
...
80105610:	c7 44 24 04 60 4e 11 	movl   $0x80114e60,0x4(%esp)
80105617:	80 
80105618:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
8010561f:	e8 9c e6 ff ff       	call   80103cc0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105624:	a1 a0 56 11 80       	mov    0x801156a0,%eax
80105629:	29 d8                	sub    %ebx,%eax
8010562b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010562e:	73 28                	jae    80105658 <sys_sleep+0x88>
    if(myproc()->killed){
80105630:	e8 8b e0 ff ff       	call   801036c0 <myproc>
80105635:	8b 40 24             	mov    0x24(%eax),%eax
80105638:	85 c0                	test   %eax,%eax
8010563a:	74 d4                	je     80105610 <sys_sleep+0x40>
      release(&tickslock);
8010563c:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105643:	e8 f8 ed ff ff       	call   80104440 <release>
      return -1;
...
8010564d:	83 c4 24             	add    $0x24,%esp
80105650:	5b                   	pop    %ebx
80105651:	5d                   	pop    %ebp
80105652:	c3                   	ret    
80105653:	90                   	nop
80105654:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105658:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010565f:	e8 dc ed ff ff       	call   80104440 <release>
  return 0;
}
80105664:	83 c4 24             	add    $0x24,%esp
      return -1;
    }
    sleep(&ticks, &tickslock);
  }
...
80105671:	eb da                	jmp    8010564d <sys_sleep+0x7d>
80105673:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80105684:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105687:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010568e:	e8 bd ec ff ff       	call   80104350 <acquire>
  xticks = ticks;
80105693:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
80105699:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801056a0:	e8 9b ed ff ff       	call   80104440 <release>
  return xticks;
}
...
801056ae:	06                   	push   %es
  pushl %fs
801056af:	0f a0                	push   %fs
  pushl %gs
801056b1:	0f a8                	push   %gs
  pushal
801056b3:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801056b4:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056b8:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056ba:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801056bc:	54                   	push   %esp
  call trap
801056bd:	e8 de 00 00 00       	call   801057a0 <trap>
  addl $4, %esp
801056c2:	83 c4 04             	add    $0x4,%esp
...
801056c5:	61                   	popa   
  popl %gs
801056c6:	0f a9                	pop    %gs
  popl %fs
801056c8:	0f a1                	pop    %fs
  popl %es
801056ca:	07                   	pop    %es
  popl %ds
801056cb:	1f                   	pop    %ds
...
80105729:	c7 44 24 04 a1 76 10 	movl   $0x801076a1,0x4(%esp)
80105730:	80 
...
801057c0:	ff 24 85 48 77 10 80 	jmp    *-0x7fef88b8(,%eax,4)
801057c7:	90                   	nop
    lapiceoi();
    break;
...
801057c8:	e8 f3 de ff ff       	call   801036c0 <myproc>
...
801057ec:	e8 af de ff ff       	call   801036a0 <cpuid>
...
801057fc:	e8 bf de ff ff       	call   801036c0 <myproc>
80105801:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105804:	e8 b7 de ff ff       	call   801036c0 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
80105833:	c7 04 24 04 77 10 80 	movl   $0x80107704,(%esp)
...
8010583e:	e8 0d ae ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
80105843:	e8 78 de ff ff       	call   801036c0 <myproc>
...
80105850:	e8 6b de ff ff       	call   801036c0 <myproc>
80105855:	85 c0                	test   %eax,%eax
80105857:	74 0c                	je     80105865 <trap+0xc5>
80105859:	e8 62 de ff ff       	call   801036c0 <myproc>
...
80105865:	e8 56 de ff ff       	call   801036c0 <myproc>
...
80105879:	74 55                	je     801058d0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010587b:	e8 40 de ff ff       	call   801036c0 <myproc>
80105880:	85 c0                	test   %eax,%eax
80105882:	74 1d                	je     801058a1 <trap+0x101>
80105884:	e8 37 de ff ff       	call   801036c0 <myproc>
...
801058c4:	e8 87 e2 ff ff       	call   80103b50 <exit>
...
801058d4:	75 a5                	jne    8010587b <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
801058d6:	e8 a5 e3 ff ff       	call   80103c80 <yield>
...
801058dd:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801058e0:	e8 bb dd ff ff       	call   801036a0 <cpuid>
...
801058ed:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
801058f0:	e8 9b ce ff ff       	call   80102790 <lapiceoi>
    break;
...
80105900:	e8 db cc ff ff       	call   801025e0 <kbdintr>
    lapiceoi();
80105905:	e8 86 ce ff ff       	call   80102790 <lapiceoi>
    break;
...
80105910:	e8 2b 02 00 00       	call   80105b40 <uartintr>
    lapiceoi();
80105915:	e8 76 ce ff ff       	call   80102790 <lapiceoi>
    break;
...
80105927:	e8 74 dd ff ff       	call   801036a0 <cpuid>
8010592c:	c7 04 24 ac 76 10 80 	movl   $0x801076ac,(%esp)
...
8010593f:	e8 0c ad ff ff       	call   80100650 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105944:	e8 47 ce ff ff       	call   80102790 <lapiceoi>
    break;
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105960:	e8 5b dd ff ff       	call   801036c0 <myproc>
80105965:	8b 70 24             	mov    0x24(%eax),%esi
80105968:	85 f6                	test   %esi,%esi
8010596a:	75 34                	jne    801059a0 <trap+0x200>
      exit(0);
    myproc()->tf = tf;
8010596c:	e8 4f dd ff ff       	call   801036c0 <myproc>
80105971:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105974:	e8 d7 ee ff ff       	call   80104850 <syscall>
    if(myproc()->killed)
80105979:	e8 42 dd ff ff       	call   801036c0 <myproc>
...
80105996:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit(0);
80105997:	e9 b4 e1 ff ff       	jmp    80103b50 <exit>
...
801059a7:	e8 a4 e1 ff ff       	call   80103b50 <exit>
...
801059b7:	e8 94 e9 ff ff       	call   80104350 <acquire>
      ticks++;
      wakeup(&ticks);
...
801059c3:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
801059ca:	e8 c1 e5 ff ff       	call   80103f90 <wakeup>
      release(&tickslock);
801059cf:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801059d6:	e8 65 ea ff ff       	call   80104440 <release>
...
801059e6:	e8 b5 dc ff ff       	call   801036a0 <cpuid>
...
801059fa:	c7 04 24 d0 76 10 80 	movl   $0x801076d0,(%esp)
80105a01:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a05:	e8 46 ac ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105a0a:	c7 04 24 a6 76 10 80 	movl   $0x801076a6,(%esp)
...
80105a77:	e8 34 cd ff ff       	call   801027b0 <microdelay>
{
  int i;
...
80105b07:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105b08:	bb c8 77 10 80       	mov    $0x801077c8,%ebx
...
80105b14:	e8 a7 c7 ff ff       	call   801022c0 <ioapicenable>
...
80105b56:	6a 00                	push   $0x0
  jmp alltraps
80105b58:	e9 50 fb ff ff       	jmp    801056ad <alltraps>
...
80105b5f:	6a 01                	push   $0x1
  jmp alltraps
80105b61:	e9 47 fb ff ff       	jmp    801056ad <alltraps>
...
80105b68:	6a 02                	push   $0x2
  jmp alltraps
80105b6a:	e9 3e fb ff ff       	jmp    801056ad <alltraps>
...
80105b71:	6a 03                	push   $0x3
  jmp alltraps
80105b73:	e9 35 fb ff ff       	jmp    801056ad <alltraps>
...
80105b7a:	6a 04                	push   $0x4
  jmp alltraps
80105b7c:	e9 2c fb ff ff       	jmp    801056ad <alltraps>
...
80105b83:	6a 05                	push   $0x5
  jmp alltraps
80105b85:	e9 23 fb ff ff       	jmp    801056ad <alltraps>
...
80105b8c:	6a 06                	push   $0x6
  jmp alltraps
80105b8e:	e9 1a fb ff ff       	jmp    801056ad <alltraps>
...
80105b95:	6a 07                	push   $0x7
  jmp alltraps
80105b97:	e9 11 fb ff ff       	jmp    801056ad <alltraps>
...
80105b9c:	6a 08                	push   $0x8
  jmp alltraps
80105b9e:	e9 0a fb ff ff       	jmp    801056ad <alltraps>
...
80105ba5:	6a 09                	push   $0x9
  jmp alltraps
80105ba7:	e9 01 fb ff ff       	jmp    801056ad <alltraps>
...
80105bac:	6a 0a                	push   $0xa
  jmp alltraps
80105bae:	e9 fa fa ff ff       	jmp    801056ad <alltraps>
...
80105bb3:	6a 0b                	push   $0xb
  jmp alltraps
80105bb5:	e9 f3 fa ff ff       	jmp    801056ad <alltraps>
...
80105bba:	6a 0c                	push   $0xc
  jmp alltraps
80105bbc:	e9 ec fa ff ff       	jmp    801056ad <alltraps>
...
80105bc1:	6a 0d                	push   $0xd
  jmp alltraps
80105bc3:	e9 e5 fa ff ff       	jmp    801056ad <alltraps>
...
80105bc8:	6a 0e                	push   $0xe
  jmp alltraps
80105bca:	e9 de fa ff ff       	jmp    801056ad <alltraps>
...
80105bd1:	6a 0f                	push   $0xf
  jmp alltraps
80105bd3:	e9 d5 fa ff ff       	jmp    801056ad <alltraps>
...
80105bda:	6a 10                	push   $0x10
  jmp alltraps
80105bdc:	e9 cc fa ff ff       	jmp    801056ad <alltraps>
...
80105be1:	6a 11                	push   $0x11
  jmp alltraps
80105be3:	e9 c5 fa ff ff       	jmp    801056ad <alltraps>
...
80105bea:	6a 12                	push   $0x12
  jmp alltraps
80105bec:	e9 bc fa ff ff       	jmp    801056ad <alltraps>
...
80105bf3:	6a 13                	push   $0x13
  jmp alltraps
80105bf5:	e9 b3 fa ff ff       	jmp    801056ad <alltraps>
...
80105bfc:	6a 14                	push   $0x14
  jmp alltraps
80105bfe:	e9 aa fa ff ff       	jmp    801056ad <alltraps>
...
80105c05:	6a 15                	push   $0x15
  jmp alltraps
80105c07:	e9 a1 fa ff ff       	jmp    801056ad <alltraps>
...
80105c0e:	6a 16                	push   $0x16
  jmp alltraps
80105c10:	e9 98 fa ff ff       	jmp    801056ad <alltraps>
...
80105c17:	6a 17                	push   $0x17
  jmp alltraps
80105c19:	e9 8f fa ff ff       	jmp    801056ad <alltraps>
...
80105c20:	6a 18                	push   $0x18
  jmp alltraps
80105c22:	e9 86 fa ff ff       	jmp    801056ad <alltraps>
...
80105c29:	6a 19                	push   $0x19
  jmp alltraps
80105c2b:	e9 7d fa ff ff       	jmp    801056ad <alltraps>
...
80105c32:	6a 1a                	push   $0x1a
  jmp alltraps
80105c34:	e9 74 fa ff ff       	jmp    801056ad <alltraps>
...
80105c3b:	6a 1b                	push   $0x1b
  jmp alltraps
80105c3d:	e9 6b fa ff ff       	jmp    801056ad <alltraps>
...
80105c44:	6a 1c                	push   $0x1c
  jmp alltraps
80105c46:	e9 62 fa ff ff       	jmp    801056ad <alltraps>
...
80105c4d:	6a 1d                	push   $0x1d
  jmp alltraps
80105c4f:	e9 59 fa ff ff       	jmp    801056ad <alltraps>
...
80105c56:	6a 1e                	push   $0x1e
  jmp alltraps
80105c58:	e9 50 fa ff ff       	jmp    801056ad <alltraps>
...
80105c5f:	6a 1f                	push   $0x1f
  jmp alltraps
80105c61:	e9 47 fa ff ff       	jmp    801056ad <alltraps>
...
80105c68:	6a 20                	push   $0x20
  jmp alltraps
80105c6a:	e9 3e fa ff ff       	jmp    801056ad <alltraps>
...
80105c71:	6a 21                	push   $0x21
  jmp alltraps
80105c73:	e9 35 fa ff ff       	jmp    801056ad <alltraps>
...
80105c7a:	6a 22                	push   $0x22
  jmp alltraps
80105c7c:	e9 2c fa ff ff       	jmp    801056ad <alltraps>
...
80105c83:	6a 23                	push   $0x23
  jmp alltraps
80105c85:	e9 23 fa ff ff       	jmp    801056ad <alltraps>
...
80105c8c:	6a 24                	push   $0x24
  jmp alltraps
80105c8e:	e9 1a fa ff ff       	jmp    801056ad <alltraps>
...
80105c95:	6a 25                	push   $0x25
  jmp alltraps
80105c97:	e9 11 fa ff ff       	jmp    801056ad <alltraps>
...
80105c9e:	6a 26                	push   $0x26
  jmp alltraps
80105ca0:	e9 08 fa ff ff       	jmp    801056ad <alltraps>
...
80105ca7:	6a 27                	push   $0x27
  jmp alltraps
80105ca9:	e9 ff f9 ff ff       	jmp    801056ad <alltraps>
...
80105cb0:	6a 28                	push   $0x28
  jmp alltraps
80105cb2:	e9 f6 f9 ff ff       	jmp    801056ad <alltraps>
...
80105cb9:	6a 29                	push   $0x29
  jmp alltraps
80105cbb:	e9 ed f9 ff ff       	jmp    801056ad <alltraps>
...
80105cc2:	6a 2a                	push   $0x2a
  jmp alltraps
80105cc4:	e9 e4 f9 ff ff       	jmp    801056ad <alltraps>
...
80105ccb:	6a 2b                	push   $0x2b
  jmp alltraps
80105ccd:	e9 db f9 ff ff       	jmp    801056ad <alltraps>
...
80105cd4:	6a 2c                	push   $0x2c
  jmp alltraps
80105cd6:	e9 d2 f9 ff ff       	jmp    801056ad <alltraps>
...
80105cdd:	6a 2d                	push   $0x2d
  jmp alltraps
80105cdf:	e9 c9 f9 ff ff       	jmp    801056ad <alltraps>
...
80105ce6:	6a 2e                	push   $0x2e
  jmp alltraps
80105ce8:	e9 c0 f9 ff ff       	jmp    801056ad <alltraps>
...
80105cef:	6a 2f                	push   $0x2f
  jmp alltraps
80105cf1:	e9 b7 f9 ff ff       	jmp    801056ad <alltraps>
...
80105cf8:	6a 30                	push   $0x30
  jmp alltraps
80105cfa:	e9 ae f9 ff ff       	jmp    801056ad <alltraps>
...
80105d01:	6a 31                	push   $0x31
  jmp alltraps
80105d03:	e9 a5 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d0a:	6a 32                	push   $0x32
  jmp alltraps
80105d0c:	e9 9c f9 ff ff       	jmp    801056ad <alltraps>
...
80105d13:	6a 33                	push   $0x33
  jmp alltraps
80105d15:	e9 93 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d1c:	6a 34                	push   $0x34
  jmp alltraps
80105d1e:	e9 8a f9 ff ff       	jmp    801056ad <alltraps>
...
80105d25:	6a 35                	push   $0x35
  jmp alltraps
80105d27:	e9 81 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d2e:	6a 36                	push   $0x36
  jmp alltraps
80105d30:	e9 78 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d37:	6a 37                	push   $0x37
  jmp alltraps
80105d39:	e9 6f f9 ff ff       	jmp    801056ad <alltraps>
...
80105d40:	6a 38                	push   $0x38
  jmp alltraps
80105d42:	e9 66 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d49:	6a 39                	push   $0x39
  jmp alltraps
80105d4b:	e9 5d f9 ff ff       	jmp    801056ad <alltraps>
...
80105d52:	6a 3a                	push   $0x3a
  jmp alltraps
80105d54:	e9 54 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d5b:	6a 3b                	push   $0x3b
  jmp alltraps
80105d5d:	e9 4b f9 ff ff       	jmp    801056ad <alltraps>
...
80105d64:	6a 3c                	push   $0x3c
  jmp alltraps
80105d66:	e9 42 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d6d:	6a 3d                	push   $0x3d
  jmp alltraps
80105d6f:	e9 39 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d76:	6a 3e                	push   $0x3e
  jmp alltraps
80105d78:	e9 30 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d7f:	6a 3f                	push   $0x3f
  jmp alltraps
80105d81:	e9 27 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d88:	6a 40                	push   $0x40
  jmp alltraps
80105d8a:	e9 1e f9 ff ff       	jmp    801056ad <alltraps>
...
80105d91:	6a 41                	push   $0x41
  jmp alltraps
80105d93:	e9 15 f9 ff ff       	jmp    801056ad <alltraps>
...
80105d9a:	6a 42                	push   $0x42
  jmp alltraps
80105d9c:	e9 0c f9 ff ff       	jmp    801056ad <alltraps>
...
80105da3:	6a 43                	push   $0x43
  jmp alltraps
80105da5:	e9 03 f9 ff ff       	jmp    801056ad <alltraps>
...
80105dac:	6a 44                	push   $0x44
  jmp alltraps
80105dae:	e9 fa f8 ff ff       	jmp    801056ad <alltraps>
...
80105db5:	6a 45                	push   $0x45
  jmp alltraps
80105db7:	e9 f1 f8 ff ff       	jmp    801056ad <alltraps>
...
80105dbe:	6a 46                	push   $0x46
  jmp alltraps
80105dc0:	e9 e8 f8 ff ff       	jmp    801056ad <alltraps>
...
80105dc7:	6a 47                	push   $0x47
  jmp alltraps
80105dc9:	e9 df f8 ff ff       	jmp    801056ad <alltraps>
...
80105dd0:	6a 48                	push   $0x48
  jmp alltraps
80105dd2:	e9 d6 f8 ff ff       	jmp    801056ad <alltraps>
...
80105dd9:	6a 49                	push   $0x49
  jmp alltraps
80105ddb:	e9 cd f8 ff ff       	jmp    801056ad <alltraps>
...
80105de2:	6a 4a                	push   $0x4a
  jmp alltraps
80105de4:	e9 c4 f8 ff ff       	jmp    801056ad <alltraps>
...
80105deb:	6a 4b                	push   $0x4b
  jmp alltraps
80105ded:	e9 bb f8 ff ff       	jmp    801056ad <alltraps>
...
80105df4:	6a 4c                	push   $0x4c
  jmp alltraps
80105df6:	e9 b2 f8 ff ff       	jmp    801056ad <alltraps>
...
80105dfd:	6a 4d                	push   $0x4d
  jmp alltraps
80105dff:	e9 a9 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e06:	6a 4e                	push   $0x4e
  jmp alltraps
80105e08:	e9 a0 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e0f:	6a 4f                	push   $0x4f
  jmp alltraps
80105e11:	e9 97 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e18:	6a 50                	push   $0x50
  jmp alltraps
80105e1a:	e9 8e f8 ff ff       	jmp    801056ad <alltraps>
...
80105e21:	6a 51                	push   $0x51
  jmp alltraps
80105e23:	e9 85 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e2a:	6a 52                	push   $0x52
  jmp alltraps
80105e2c:	e9 7c f8 ff ff       	jmp    801056ad <alltraps>
...
80105e33:	6a 53                	push   $0x53
  jmp alltraps
80105e35:	e9 73 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e3c:	6a 54                	push   $0x54
  jmp alltraps
80105e3e:	e9 6a f8 ff ff       	jmp    801056ad <alltraps>
...
80105e45:	6a 55                	push   $0x55
  jmp alltraps
80105e47:	e9 61 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e4e:	6a 56                	push   $0x56
  jmp alltraps
80105e50:	e9 58 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e57:	6a 57                	push   $0x57
  jmp alltraps
80105e59:	e9 4f f8 ff ff       	jmp    801056ad <alltraps>
...
80105e60:	6a 58                	push   $0x58
  jmp alltraps
80105e62:	e9 46 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e69:	6a 59                	push   $0x59
  jmp alltraps
80105e6b:	e9 3d f8 ff ff       	jmp    801056ad <alltraps>
...
80105e72:	6a 5a                	push   $0x5a
  jmp alltraps
80105e74:	e9 34 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e7b:	6a 5b                	push   $0x5b
  jmp alltraps
80105e7d:	e9 2b f8 ff ff       	jmp    801056ad <alltraps>
...
80105e84:	6a 5c                	push   $0x5c
  jmp alltraps
80105e86:	e9 22 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e8d:	6a 5d                	push   $0x5d
  jmp alltraps
80105e8f:	e9 19 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e96:	6a 5e                	push   $0x5e
  jmp alltraps
80105e98:	e9 10 f8 ff ff       	jmp    801056ad <alltraps>
...
80105e9f:	6a 5f                	push   $0x5f
  jmp alltraps
80105ea1:	e9 07 f8 ff ff       	jmp    801056ad <alltraps>
...
80105ea8:	6a 60                	push   $0x60
  jmp alltraps
80105eaa:	e9 fe f7 ff ff       	jmp    801056ad <alltraps>
...
80105eb1:	6a 61                	push   $0x61
  jmp alltraps
80105eb3:	e9 f5 f7 ff ff       	jmp    801056ad <alltraps>
...
80105eba:	6a 62                	push   $0x62
  jmp alltraps
80105ebc:	e9 ec f7 ff ff       	jmp    801056ad <alltraps>
...
80105ec3:	6a 63                	push   $0x63
  jmp alltraps
80105ec5:	e9 e3 f7 ff ff       	jmp    801056ad <alltraps>
...
80105ecc:	6a 64                	push   $0x64
  jmp alltraps
80105ece:	e9 da f7 ff ff       	jmp    801056ad <alltraps>
...
80105ed5:	6a 65                	push   $0x65
  jmp alltraps
80105ed7:	e9 d1 f7 ff ff       	jmp    801056ad <alltraps>
...
80105ede:	6a 66                	push   $0x66
  jmp alltraps
80105ee0:	e9 c8 f7 ff ff       	jmp    801056ad <alltraps>
...
80105ee7:	6a 67                	push   $0x67
  jmp alltraps
80105ee9:	e9 bf f7 ff ff       	jmp    801056ad <alltraps>
...
80105ef0:	6a 68                	push   $0x68
  jmp alltraps
80105ef2:	e9 b6 f7 ff ff       	jmp    801056ad <alltraps>
...
80105ef9:	6a 69                	push   $0x69
  jmp alltraps
80105efb:	e9 ad f7 ff ff       	jmp    801056ad <alltraps>
...
80105f02:	6a 6a                	push   $0x6a
  jmp alltraps
80105f04:	e9 a4 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f0b:	6a 6b                	push   $0x6b
  jmp alltraps
80105f0d:	e9 9b f7 ff ff       	jmp    801056ad <alltraps>
...
80105f14:	6a 6c                	push   $0x6c
  jmp alltraps
80105f16:	e9 92 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f1d:	6a 6d                	push   $0x6d
  jmp alltraps
80105f1f:	e9 89 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f26:	6a 6e                	push   $0x6e
  jmp alltraps
80105f28:	e9 80 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f2f:	6a 6f                	push   $0x6f
  jmp alltraps
80105f31:	e9 77 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f38:	6a 70                	push   $0x70
  jmp alltraps
80105f3a:	e9 6e f7 ff ff       	jmp    801056ad <alltraps>
...
80105f41:	6a 71                	push   $0x71
  jmp alltraps
80105f43:	e9 65 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f4a:	6a 72                	push   $0x72
  jmp alltraps
80105f4c:	e9 5c f7 ff ff       	jmp    801056ad <alltraps>
...
80105f53:	6a 73                	push   $0x73
  jmp alltraps
80105f55:	e9 53 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f5c:	6a 74                	push   $0x74
  jmp alltraps
80105f5e:	e9 4a f7 ff ff       	jmp    801056ad <alltraps>
...
80105f65:	6a 75                	push   $0x75
  jmp alltraps
80105f67:	e9 41 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f6e:	6a 76                	push   $0x76
  jmp alltraps
80105f70:	e9 38 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f77:	6a 77                	push   $0x77
  jmp alltraps
80105f79:	e9 2f f7 ff ff       	jmp    801056ad <alltraps>
...
80105f80:	6a 78                	push   $0x78
  jmp alltraps
80105f82:	e9 26 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f89:	6a 79                	push   $0x79
  jmp alltraps
80105f8b:	e9 1d f7 ff ff       	jmp    801056ad <alltraps>
...
80105f92:	6a 7a                	push   $0x7a
  jmp alltraps
80105f94:	e9 14 f7 ff ff       	jmp    801056ad <alltraps>
...
80105f9b:	6a 7b                	push   $0x7b
  jmp alltraps
80105f9d:	e9 0b f7 ff ff       	jmp    801056ad <alltraps>
...
80105fa4:	6a 7c                	push   $0x7c
  jmp alltraps
80105fa6:	e9 02 f7 ff ff       	jmp    801056ad <alltraps>
...
80105fad:	6a 7d                	push   $0x7d
  jmp alltraps
80105faf:	e9 f9 f6 ff ff       	jmp    801056ad <alltraps>
...
80105fb6:	6a 7e                	push   $0x7e
  jmp alltraps
80105fb8:	e9 f0 f6 ff ff       	jmp    801056ad <alltraps>
...
80105fbf:	6a 7f                	push   $0x7f
  jmp alltraps
80105fc1:	e9 e7 f6 ff ff       	jmp    801056ad <alltraps>
...
80105fc8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fcd:	e9 db f6 ff ff       	jmp    801056ad <alltraps>
...
80105fd4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fd9:	e9 cf f6 ff ff       	jmp    801056ad <alltraps>
...
80105fe0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fe5:	e9 c3 f6 ff ff       	jmp    801056ad <alltraps>
...
80105fec:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105ff1:	e9 b7 f6 ff ff       	jmp    801056ad <alltraps>
...
80105ff8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105ffd:	e9 ab f6 ff ff       	jmp    801056ad <alltraps>
...
80106004:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106009:	e9 9f f6 ff ff       	jmp    801056ad <alltraps>
...
80106010:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106015:	e9 93 f6 ff ff       	jmp    801056ad <alltraps>
...
8010601c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106021:	e9 87 f6 ff ff       	jmp    801056ad <alltraps>
...
80106028:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010602d:	e9 7b f6 ff ff       	jmp    801056ad <alltraps>
...
80106034:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106039:	e9 6f f6 ff ff       	jmp    801056ad <alltraps>
...
80106040:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106045:	e9 63 f6 ff ff       	jmp    801056ad <alltraps>
...
8010604c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106051:	e9 57 f6 ff ff       	jmp    801056ad <alltraps>
...
80106058:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010605d:	e9 4b f6 ff ff       	jmp    801056ad <alltraps>
...
80106064:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106069:	e9 3f f6 ff ff       	jmp    801056ad <alltraps>
...
80106070:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106075:	e9 33 f6 ff ff       	jmp    801056ad <alltraps>
...
8010607c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106081:	e9 27 f6 ff ff       	jmp    801056ad <alltraps>
...
80106088:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010608d:	e9 1b f6 ff ff       	jmp    801056ad <alltraps>
...
80106094:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106099:	e9 0f f6 ff ff       	jmp    801056ad <alltraps>
...
801060a0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060a5:	e9 03 f6 ff ff       	jmp    801056ad <alltraps>
...
801060ac:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060b1:	e9 f7 f5 ff ff       	jmp    801056ad <alltraps>
...
801060b8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060bd:	e9 eb f5 ff ff       	jmp    801056ad <alltraps>
...
801060c4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060c9:	e9 df f5 ff ff       	jmp    801056ad <alltraps>
...
801060d0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060d5:	e9 d3 f5 ff ff       	jmp    801056ad <alltraps>
...
801060dc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060e1:	e9 c7 f5 ff ff       	jmp    801056ad <alltraps>
...
801060e8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060ed:	e9 bb f5 ff ff       	jmp    801056ad <alltraps>
...
801060f4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060f9:	e9 af f5 ff ff       	jmp    801056ad <alltraps>
...
80106100:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106105:	e9 a3 f5 ff ff       	jmp    801056ad <alltraps>
...
8010610c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106111:	e9 97 f5 ff ff       	jmp    801056ad <alltraps>
...
80106118:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010611d:	e9 8b f5 ff ff       	jmp    801056ad <alltraps>
...
80106124:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106129:	e9 7f f5 ff ff       	jmp    801056ad <alltraps>
...
80106130:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106135:	e9 73 f5 ff ff       	jmp    801056ad <alltraps>
...
8010613c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106141:	e9 67 f5 ff ff       	jmp    801056ad <alltraps>
...
80106148:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010614d:	e9 5b f5 ff ff       	jmp    801056ad <alltraps>
...
80106154:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106159:	e9 4f f5 ff ff       	jmp    801056ad <alltraps>
...
80106160:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106165:	e9 43 f5 ff ff       	jmp    801056ad <alltraps>
...
8010616c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106171:	e9 37 f5 ff ff       	jmp    801056ad <alltraps>
...
80106178:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010617d:	e9 2b f5 ff ff       	jmp    801056ad <alltraps>
...
80106184:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106189:	e9 1f f5 ff ff       	jmp    801056ad <alltraps>
...
80106190:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106195:	e9 13 f5 ff ff       	jmp    801056ad <alltraps>
...
8010619c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061a1:	e9 07 f5 ff ff       	jmp    801056ad <alltraps>
...
801061a8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061ad:	e9 fb f4 ff ff       	jmp    801056ad <alltraps>
...
801061b4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061b9:	e9 ef f4 ff ff       	jmp    801056ad <alltraps>
...
801061c0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061c5:	e9 e3 f4 ff ff       	jmp    801056ad <alltraps>
...
801061cc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061d1:	e9 d7 f4 ff ff       	jmp    801056ad <alltraps>
...
801061d8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061dd:	e9 cb f4 ff ff       	jmp    801056ad <alltraps>
...
801061e4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061e9:	e9 bf f4 ff ff       	jmp    801056ad <alltraps>
...
801061f0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061f5:	e9 b3 f4 ff ff       	jmp    801056ad <alltraps>
...
801061fc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106201:	e9 a7 f4 ff ff       	jmp    801056ad <alltraps>
...
80106208:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010620d:	e9 9b f4 ff ff       	jmp    801056ad <alltraps>
...
80106214:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106219:	e9 8f f4 ff ff       	jmp    801056ad <alltraps>
...
80106220:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106225:	e9 83 f4 ff ff       	jmp    801056ad <alltraps>
...
8010622c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106231:	e9 77 f4 ff ff       	jmp    801056ad <alltraps>
...
80106238:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010623d:	e9 6b f4 ff ff       	jmp    801056ad <alltraps>
...
80106244:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106249:	e9 5f f4 ff ff       	jmp    801056ad <alltraps>
...
80106250:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106255:	e9 53 f4 ff ff       	jmp    801056ad <alltraps>
...
8010625c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106261:	e9 47 f4 ff ff       	jmp    801056ad <alltraps>
...
80106268:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010626d:	e9 3b f4 ff ff       	jmp    801056ad <alltraps>
...
80106274:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106279:	e9 2f f4 ff ff       	jmp    801056ad <alltraps>
...
80106280:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106285:	e9 23 f4 ff ff       	jmp    801056ad <alltraps>
...
8010628c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106291:	e9 17 f4 ff ff       	jmp    801056ad <alltraps>
...
80106298:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010629d:	e9 0b f4 ff ff       	jmp    801056ad <alltraps>
...
801062a4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062a9:	e9 ff f3 ff ff       	jmp    801056ad <alltraps>
...
801062b0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062b5:	e9 f3 f3 ff ff       	jmp    801056ad <alltraps>
...
801062bc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062c1:	e9 e7 f3 ff ff       	jmp    801056ad <alltraps>
...
801062c8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062cd:	e9 db f3 ff ff       	jmp    801056ad <alltraps>
...
801062d4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062d9:	e9 cf f3 ff ff       	jmp    801056ad <alltraps>
...
801062e0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062e5:	e9 c3 f3 ff ff       	jmp    801056ad <alltraps>
...
801062ec:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062f1:	e9 b7 f3 ff ff       	jmp    801056ad <alltraps>
...
801062f8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062fd:	e9 ab f3 ff ff       	jmp    801056ad <alltraps>
...
80106304:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106309:	e9 9f f3 ff ff       	jmp    801056ad <alltraps>
...
80106310:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106315:	e9 93 f3 ff ff       	jmp    801056ad <alltraps>
...
8010631c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106321:	e9 87 f3 ff ff       	jmp    801056ad <alltraps>
...
80106328:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010632d:	e9 7b f3 ff ff       	jmp    801056ad <alltraps>
...
80106334:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106339:	e9 6f f3 ff ff       	jmp    801056ad <alltraps>
...
80106340:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106345:	e9 63 f3 ff ff       	jmp    801056ad <alltraps>
...
8010634c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106351:	e9 57 f3 ff ff       	jmp    801056ad <alltraps>
...
80106358:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010635d:	e9 4b f3 ff ff       	jmp    801056ad <alltraps>
...
80106364:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106369:	e9 3f f3 ff ff       	jmp    801056ad <alltraps>
...
80106370:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106375:	e9 33 f3 ff ff       	jmp    801056ad <alltraps>
...
8010637c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106381:	e9 27 f3 ff ff       	jmp    801056ad <alltraps>
...
80106388:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010638d:	e9 1b f3 ff ff       	jmp    801056ad <alltraps>
...
80106394:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106399:	e9 0f f3 ff ff       	jmp    801056ad <alltraps>
...
801063a0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063a5:	e9 03 f3 ff ff       	jmp    801056ad <alltraps>
...
801063ac:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063b1:	e9 f7 f2 ff ff       	jmp    801056ad <alltraps>
...
801063b8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063bd:	e9 eb f2 ff ff       	jmp    801056ad <alltraps>
...
801063c4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063c9:	e9 df f2 ff ff       	jmp    801056ad <alltraps>
...
801063d0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063d5:	e9 d3 f2 ff ff       	jmp    801056ad <alltraps>
...
801063dc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063e1:	e9 c7 f2 ff ff       	jmp    801056ad <alltraps>
...
801063e8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063ed:	e9 bb f2 ff ff       	jmp    801056ad <alltraps>
...
801063f4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063f9:	e9 af f2 ff ff       	jmp    801056ad <alltraps>
...
80106400:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106405:	e9 a3 f2 ff ff       	jmp    801056ad <alltraps>
...
8010640c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106411:	e9 97 f2 ff ff       	jmp    801056ad <alltraps>
...
80106418:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010641d:	e9 8b f2 ff ff       	jmp    801056ad <alltraps>
...
80106424:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106429:	e9 7f f2 ff ff       	jmp    801056ad <alltraps>
...
80106430:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106435:	e9 73 f2 ff ff       	jmp    801056ad <alltraps>
...
8010643c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106441:	e9 67 f2 ff ff       	jmp    801056ad <alltraps>
...
80106448:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010644d:	e9 5b f2 ff ff       	jmp    801056ad <alltraps>
...
80106454:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106459:	e9 4f f2 ff ff       	jmp    801056ad <alltraps>
...
80106460:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106465:	e9 43 f2 ff ff       	jmp    801056ad <alltraps>
...
8010646c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106471:	e9 37 f2 ff ff       	jmp    801056ad <alltraps>
...
80106478:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010647d:	e9 2b f2 ff ff       	jmp    801056ad <alltraps>
...
80106484:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106489:	e9 1f f2 ff ff       	jmp    801056ad <alltraps>
...
80106490:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106495:	e9 13 f2 ff ff       	jmp    801056ad <alltraps>
...
8010649c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064a1:	e9 07 f2 ff ff       	jmp    801056ad <alltraps>
...
801064a8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064ad:	e9 fb f1 ff ff       	jmp    801056ad <alltraps>
...
801064b4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064b9:	e9 ef f1 ff ff       	jmp    801056ad <alltraps>
...
801064c0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064c5:	e9 e3 f1 ff ff       	jmp    801056ad <alltraps>
...
801064cc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064d1:	e9 d7 f1 ff ff       	jmp    801056ad <alltraps>
...
801064d8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064dd:	e9 cb f1 ff ff       	jmp    801056ad <alltraps>
...
801064e4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064e9:	e9 bf f1 ff ff       	jmp    801056ad <alltraps>
...
801064f0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064f5:	e9 b3 f1 ff ff       	jmp    801056ad <alltraps>
...
801064fc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106501:	e9 a7 f1 ff ff       	jmp    801056ad <alltraps>
...
80106508:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010650d:	e9 9b f1 ff ff       	jmp    801056ad <alltraps>
...
80106514:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106519:	e9 8f f1 ff ff       	jmp    801056ad <alltraps>
...
80106520:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106525:	e9 83 f1 ff ff       	jmp    801056ad <alltraps>
...
8010652c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106531:	e9 77 f1 ff ff       	jmp    801056ad <alltraps>
...
80106538:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010653d:	e9 6b f1 ff ff       	jmp    801056ad <alltraps>
...
80106544:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106549:	e9 5f f1 ff ff       	jmp    801056ad <alltraps>
...
80106550:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106555:	e9 53 f1 ff ff       	jmp    801056ad <alltraps>
...
8010655c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106561:	e9 47 f1 ff ff       	jmp    801056ad <alltraps>
...
80106568:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010656d:	e9 3b f1 ff ff       	jmp    801056ad <alltraps>
...
80106574:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106579:	e9 2f f1 ff ff       	jmp    801056ad <alltraps>
...
80106580:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106585:	e9 23 f1 ff ff       	jmp    801056ad <alltraps>
...
8010658c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106591:	e9 17 f1 ff ff       	jmp    801056ad <alltraps>
...
80106598:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010659d:	e9 0b f1 ff ff       	jmp    801056ad <alltraps>
...
801065a4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065a9:	e9 ff f0 ff ff       	jmp    801056ad <alltraps>
...
801065b0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065b5:	e9 f3 f0 ff ff       	jmp    801056ad <alltraps>
...
801065bc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065c1:	e9 e7 f0 ff ff       	jmp    801056ad <alltraps>
...
80106614:	e8 97 be ff ff       	call   801024b0 <kalloc>
...
80106632:	e8 59 de ff ff       	call   80104490 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066d1:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
801066d2:	c7 04 24 d0 77 10 80 	movl   $0x801077d0,(%esp)
...
80106723:	e8 d8 bb ff ff       	call   80102300 <kfree>
      *pte = 0;
...
80106783:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106786:	e8 15 cf ff ff       	call   801036a0 <cpuid>
...
8010688f:	e8 8c cd ff ff       	call   80103620 <mycpu>
80106894:	89 c3                	mov    %eax,%ebx
80106896:	e8 85 cd ff ff       	call   80103620 <mycpu>
8010689b:	89 c7                	mov    %eax,%edi
8010689d:	e8 7e cd ff ff       	call   80103620 <mycpu>
801068a2:	83 c7 08             	add    $0x8,%edi
801068a5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068a8:	e8 73 cd ff ff       	call   80103620 <mycpu>
...
801068e9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
801068ee:	e8 2d cd ff ff       	call   80103620 <mycpu>
801068f3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801068fa:	e8 21 cd ff ff       	call   80103620 <mycpu>
801068ff:	b9 10 00 00 00       	mov    $0x10,%ecx
80106904:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106908:	e8 13 cd ff ff       	call   80103620 <mycpu>
...
80106916:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106919:	e8 02 cd ff ff       	call   80103620 <mycpu>
...
8010693b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010693c:	e9 8f da ff ff       	jmp    801043d0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106941:	c7 04 24 d6 77 10 80 	movl   $0x801077d6,(%esp)
80106948:	e8 13 9a ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010694d:	c7 04 24 01 78 10 80 	movl   $0x80107801,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80106959:	c7 04 24 ec 77 10 80 	movl   $0x801077ec,(%esp)
...
8010698b:	77 54                	ja     801069e1 <inituvm+0x71>
  ...
  mem = kalloc();
8010698d:	e8 1e bb ff ff       	call   801024b0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801069a7:	e8 e4 da ff ff       	call   80104490 <memset>
...
801069db:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801069dc:	e9 4f db ff ff       	jmp    80104530 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
801069e1:	c7 04 24 15 78 10 80 	movl   $0x80107815,(%esp)
...
80106a6d:	e8 fe ae ff ff       	call   80101970 <readi>
...
80106a91:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106a92:	c7 04 24 2f 78 10 80 	movl   $0x8010782f,(%esp)
80106a99:	e8 c2 98 ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
80106a9e:	c7 04 24 d0 78 10 80 	movl   $0x801078d0,(%esp)
...
80106af3:	e8 98 d9 ff ff       	call   80104490 <memset>
...
80106b24:	76 2a                	jbe    80106b50 <allocuvm+0xa0>
    mem = kalloc();
80106b26:	e8 85 b9 ff ff       	call   801024b0 <kalloc>
    if(mem == 0){
...
80106b2f:	75 af                	jne    80106ae0 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106b31:	c7 04 24 4d 78 10 80 	movl   $0x8010784d,(%esp)
...
80106b5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106b60:	c7 04 24 65 78 10 80 	movl   $0x80107865,(%esp)
...
80106b81:	e8 7a b7 ff ff       	call   80102300 <kfree>
      return 0;
...
80106c0d:	e8 ee b6 ff ff       	call   80102300 <kfree>
  uint i;
...
80106c22:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106c23:	e9 d8 b6 ff ff       	jmp    80102300 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106c28:	c7 04 24 81 78 10 80 	movl   $0x80107881,(%esp)
...
80106c48:	e8 63 b8 ff ff       	call   801024b0 <kalloc>
...
80106c6b:	e8 20 d8 ff ff       	call   80104490 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106d0b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106d0c:	c7 04 24 92 78 10 80 	movl   $0x80107892,(%esp)
...
80106d48:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106d4e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d55:	00 
80106d56:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106d5a:	89 04 24             	mov    %eax,(%esp)
80106d5d:	e8 ce d7 ff ff       	call   80104530 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106d62:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d65:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106d6b:	89 14 24             	mov    %edx,(%esp)
80106d6e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d73:	89 da                	mov    %ebx,%edx
...
80106d83:	78 41                	js     80106dc6 <copyuvm+0xa6>
  uint pa, i, flags;
  char *mem;
...
80106d8b:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
...
80106d9e:	74 5b                	je     80106dfb <copyuvm+0xdb>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106da0:	8b 30                	mov    (%eax),%esi
80106da2:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106da8:	74 45                	je     80106def <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106daa:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106dac:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106db2:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106db5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106dbb:	e8 f0 b6 ff ff       	call   801024b0 <kalloc>
80106dc0:	85 c0                	test   %eax,%eax
80106dc2:	89 c6                	mov    %eax,%esi
80106dc4:	75 82                	jne    80106d48 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
bad:
  freevm(d);
80106dc6:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106dc9:	89 04 24             	mov    %eax,(%esp)
80106dcc:	e8 ef fd ff ff       	call   80106bc0 <freevm>
  return 0;
...
80106de3:	83 c4 2c             	add    $0x2c,%esp
80106de6:	5b                   	pop    %ebx
80106de7:	5e                   	pop    %esi
80106de8:	5f                   	pop    %edi
80106de9:	5d                   	pop    %ebp
...
80106ded:	eb e4                	jmp    80106dd3 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106def:	c7 04 24 b6 78 10 80 	movl   $0x801078b6,(%esp)
80106df6:	e8 65 95 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106dfb:	c7 04 24 9c 78 10 80 	movl   $0x8010789c,(%esp)
80106e02:	e8 59 95 ff ff       	call   80100360 <panic>
...
80106e8c:	e8 9f d6 ff ff       	call   80104530 <memmove>
    len -= n;
    buf += n;
